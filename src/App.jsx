  ...
  return {
    ...
    routine: {
      ...
      evening: [
        ...
        {id:10,label:"No screens after 9pm 📵",done:false},{id:11,label:"Read 20 min 📖",done:false},
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize:22, fontWeight:800, color:C.text, marginBottom:4 }}>Your Space</div>
  ...
  return (
    <div style={{
      ...
      <div style={{ fontFamily:F, fontWeight:800, fontSize:20, color:C.text, display:"flex", alignItems:"center", gap:8 }}>
        <span>🖤💗</span><span>Your Space</span>
      </div>
...
function Fitness({ data, update }) {
  ...
  return (
    <div>
      ...
      <SectionTitle icon="😴" title="Sleep" />
      <Card>
        <div style={{ display:"flex", gap:10 }}>
          <div style={{ flex:1 }}>
            <div style={{ fontFamily:FB, fontSize:12, color:C.textDim, marginBottom:4 }}>Target bedtime</div>
            <div style={{ fontFamily:F, fontSize:18, fontWeight:800, color:C.text }}>{data.fitness.targetSleep}</div>
          </div>
          <div style={{ flex:1 }}>
            <div style={{ fontFamily:FB, fontSize:12, color:C.textDim, marginBottom:4 }}>Target wake</div>
            <div style={{ fontFamily:F, fontSize:18, fontWeight:800, color:C.text }}>{data.fitness.targetWake}</div>
          </div>
        </div>
      </Card>
    </div>
...
function Diet({ data, update }) {
  ...
  return (
    <div>
      ...
      <SectionTitle icon="🥗" title="Meals" />
      <Card>
        <div style={{ fontFamily:FB, fontSize:13, color:C.textDim }}>Use Routine tab to track breakfast & dinner check ins.</div>
      </Card>
    </div>
  );
}
...
function Finance({ data, update }) {
  ...
  const totalExpenses = data.finance.expenses.reduce((s,e)=>s+e.amount,0);

  return (
    <div>
      <SectionTitle icon="💸" title="Expenses" sub={`Total: ${totalExpenses.toFixed(2)}`} />
      <Card>
        <div style={{ display:"flex", gap:8, marginBottom:12 }}>
